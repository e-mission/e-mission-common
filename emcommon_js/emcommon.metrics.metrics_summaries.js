// Transcrypt'ed from Python, 2024-09-12 15:15:24
...
export {emcmff, util, emcdb, emcsc, emcfu, emcble, Log, emcdu};
...
export var value_of_metric_for_trip = async function (metric_name, grouping_field, grouping_val, trip) {
	if (metric_name == 'distance') {
		...
		var __left0__ = await emcmff.calc_footprint_for_trip (trip, app_config ['label_options'], grouping_val, labels_map);
